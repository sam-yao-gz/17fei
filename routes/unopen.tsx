...
export default function Page() {
  return (
    <div class="p-2 w-full leading-8 min-h-screen text-shadow bg-yellow-400 text-lg text-red-100">
      <div class="max-w-screen-md mx-auto flex flex-col items-center justify-center">
        ...
        <div class="p-4 border-4 rounded bg-yellow-500 border-double">
        ...
        <a class="bg-yellow-600 m-8 p-2 border rounded" href="/">返回首页</a>
